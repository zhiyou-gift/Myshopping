    ...
    public void insertGoodsInfos(List<GoodsInfo> list) {
        ...
        try {
            ...
            for (GoodsInfo info : list) {
                ...
                long rowId = mWDB.insert(TABLE_GOODS_INFO, null, values);
                if (rowId == -1) {
                    Log.e("Insert", "Failed to insert record: " + values.toString());
                } else {
                    Log.d("Insert", "Record inserted successfully, rowId: " + rowId);
                }
            }
